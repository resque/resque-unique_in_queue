# kettle-jem:freeze
# To retain chunks of comments & code during resque-unique_in_queue templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# resque-unique_in_queue will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
