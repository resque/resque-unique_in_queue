...
# resque-unique_in_queue Rakefile v7.1.0 - 2026-08-01
...
#
# Sets up tasks for appraisal2, floss_funding, kettle-jem, kettle-dev, rspec, rubocop_gradual, reek, yard, and stone_checksums.
#
...
# rake install                                # Build and install resque-unique_in_queue-1.0.0.gem in...
# rake install:local                          # Build and install resque-unique_in_queue-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template resque-unique_in_queue against itse...
