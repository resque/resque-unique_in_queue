...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/resque/unique_in_queue/version.rb", mod) }::Resque::UniqueInQueue::Version::VERSION
  else
    require_relative "lib/resque/unique_in_queue/version"
    Resque::UniqueInQueue::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.description = "💎 A resque plugin that ensures job uniqueness at enqueue time."
  spec.homepage = "https://github.com/resque/resque-unique_in_queue"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://resque-unique-in-queue.galtzo.com"
